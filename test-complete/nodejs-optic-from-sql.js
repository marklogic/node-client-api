...
describe('Node.js Optic from sql test', function(){
  ...
  it('TEST 4 - sql group by - format xml', function(done){
    ...
    .then(function(output) {
      ...
      expect(outputStr).to.equal('<t:table xmlns:t="http://marklogic.com/table"><t:columns><t:column name="opticFunctionalTest.master.name" type="xs:string"/><t:column name="DetailName" type="xs:string"/><t:column name="opticFunctionalTest.detail.color" type="xs:string"/><t:column name="DetailSum" type="xs:double"/></t:columns><t:rows><t:row><t:cell name="opticFunctionalTest.master.name">Master 1</t:cell><t:cell name="DetailName">Detail 5</t:cell><t:cell name="opticFunctionalTest.detail.color">green</t:cell><t:cell name="DetailSum">90.09</t:cell></t:row><t:row><t:cell name="opticFunctionalTest.master.name">Master 2</t:cell><t:cell name="DetailName">Detail 4</t:cell><t:cell name="opticFunctionalTest.detail.color">green</t:cell><t:cell name="DetailSum">120.12</t:cell></t:row></t:rows></t:table>');
      done();
    }, done);
  });
