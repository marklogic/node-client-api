...
function applyGraph(action, uri) {
  /*jshint validthis:true */
  var endpoint = (uri === null) ? '/v1/graphs?default' : encodeURI('/v1/graphs?graph='+uri);
...
Graphs.prototype.sparql = function queryGraphSPARQL() {
  ...
  var hasDefaultGraphs = (defaultGraphs != null);
  if (hasDefaultGraphs) {
  ...
  var hasNamedGraphs = (namedGraphs != null);
  if (hasNamedGraphs) {
