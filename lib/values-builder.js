 ...
 * the {@link valuesBuilder#fromIndexes} function to create the BuiltQuery
 * for the values query before calling functions to specify the other
 * clauses of the built query.
