...
/**
    ...
    */
number(...args) {
    const paramdef = ['arg', [types.XsAnyAtomicType, PlanColumn, PlanParam], false, false];
...
/**
    ...
    */
iri(...args) {
    const paramdef = ['string-iri', [types.XsAnyAtomicType, PlanColumn, PlanParam], false, false];
...
class XsExpr {
  ...
  /**
    * Constructs or casts an expression to a XsAnyURI object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.anyURI|xs.anyURI}
...
/**
    * Constructs or casts an expression to a XsBase64Binary object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.base64Binary|xs.base64Binary}
...
/**
    * Constructs or casts an expression to a XsBoolean object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.boolean|xs.boolean}
...
/**
    * Constructs or casts an expression to a XsByte object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.byte|xs.byte}
...
/**
    * Constructs or casts an expression to a XsDate object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.date|xs.date}
...
/**
    * Constructs or casts an expression to a XsDateTime object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.dateTime|xs.dateTime}
...
/**
    * Constructs or casts an expression to a XsDayTimeDuration object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.dayTimeDuration|xs.dayTimeDuration}
...
/**
    * Constructs or casts an expression to a XsDecimal object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.decimal|xs.decimal}
...
/**
    * Constructs or casts an expression to a XsDouble object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.double|xs.double}
...
/**
    * Constructs or casts an expression to a XsFloat object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.float|xs.float}
...
/**
    * Constructs or casts an expression to a XsGDay object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.gDay|xs.gDay}
...
/**
    * Constructs or casts an expression to a XsGMonth object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.gMonth|xs.gMonth}
...
/**
    * Constructs or casts an expression to a XsGMonthDay object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.gMonthDay|xs.gMonthDay}
...
/**
    * Constructs or casts an expression to a XsGYear object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.gYear|xs.gYear}
...
/**
    * Constructs or casts an expression to a XsGYearMonth object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.gYearMonth|xs.gYearMonth}
...
/**
    * Constructs or casts an expression to a XsHexBinary object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.hexBinary|xs.hexBinary}
...
/**
    * Constructs or casts an expression to a XsInt object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.int|xs.int}
...
/**
    * Constructs or casts an expression to a XsInteger object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.integer|xs.integer}
...
/**
    * Constructs or casts an expression to a XsLanguage object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.language|xs.language}
...
/**
    * Constructs or casts an expression to a XsLong object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.long|xs.long}
...
/**
    * Constructs or casts an expression to a XsName object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.Name|xs.Name}
...
/**
    * Constructs or casts an expression to a XsNCName object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.NCName|xs.NCName}
...
/**
    * Constructs or casts an expression to a XsNegativeInteger object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.negativeInteger|xs.negativeInteger}
...
/**
    * Constructs or casts an expression to a XsNMTOKEN object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.NMTOKEN|xs.NMTOKEN}
...
/**
    * Constructs or casts an expression to a XsNonNegativeInteger object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.nonNegativeInteger|xs.nonNegativeInteger}
...
/**
    * Constructs or casts an expression to a XsNonPositiveInteger object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.nonPositiveInteger|xs.nonPositiveInteger}
...
/**
    * Constructs or casts an expression to a XsNormalizedString object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.normalizedString|xs.normalizedString}
...
/**
    * Constructs or casts an expression to a XsNumeric object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.numeric|xs.numeric}
...
/**
    * Constructs or casts an expression to a XsPositiveInteger object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.positiveInteger|xs.positiveInteger}
...
/**
    * Constructs or casts an expression to a XsQName object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.QName|xs.QName}
...
/**
    * Constructs or casts an expression to a XsShort object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.short|xs.short}
...
/**
    * Constructs or casts an expression to a XsString object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.string|xs.string}
...
/**
    * Constructs or casts an expression to a XsTime object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.time|xs.time}
...
/**
    * Constructs or casts an expression to a XsToken object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.token|xs.token}
...
/**
    * Constructs or casts an expression to a XsUnsignedByte object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.unsignedByte|xs.unsignedByte}
...
/**
    * Constructs or casts an expression to a XsUnsignedInt object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.unsignedInt|xs.unsignedInt}
...
/**
    * Constructs or casts an expression to a XsUnsignedLong object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.unsignedLong|xs.unsignedLong}
...
/**
    * Constructs or casts an expression to a XsUnsignedShort object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.unsignedShort|xs.unsignedShort}
...
/**
    * Constructs or casts an expression to a XsUntypedAtomic object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.untypedAtomic|xs.untypedAtomic}
...
/**
    * Constructs or casts an expression to a XsYearMonthDuration object. Provides a client interface to a server function. See {@link http://docs.marklogic.com/xs.yearMonthDuration|xs.yearMonthDuration}
...
class PlanExprColName extends types.ServerType {
...
class PlanJsonContentVal extends types.ServerType {
...
class PlanParamName extends types.ServerType {
...
class PlanSortKeyName extends types.ServerType {
...
class PlanQualifiableName extends types.ServerType {
...
class PlanColumnName extends types.ServerType {
...
class PlanAggregateColName extends types.ServerType {
...
class PlanGroupConcatString extends types.ServerType {
...
/**
    * This method applies a function or the builtin reducer to each row returned by the plan to produce a single result as with the reduce() method of JavaScript Array.  Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.reduce|op.reduce}
...
/**
    * This method collapses a group of rows into a single row.  Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.groupBy|op.groupBy}
    * @method planBuilder.ModifyPlan#groupBy
    * @since 2.1.1
    * @param { PlanExprColName } [keys] - The Optic Plan. You can either use the XQuery => chaining operator or specify the variable that captures the return value from the previous operation.
    * @param { PlanAggregateColName } [aggregates] - This parameter specifies the columns used to determine the groups. Rows with the same values in these columns are consolidated into a single group. The columns can be existing columns or new columns created by an expression specified with <a>op:as</a>. The rows produced by the group by operation include the key columns. Specify an empty sequence to create a single group for all of the rows in the row set.
    * @returns { planBuilder.ModifyPlan }
    */
groupBy(...args) {
...
/**
    ...
    * @since 2.1.1
    * @param { PlanColumnName } [docCol] - The Optic Plan. You can either use the XQuery => chaining operator or specify the variable that captures the return value from the previous operation.
...
/**
    ...
    * @since 2.1.1
    * @param { PlanColumnName } [uriCol] - The Optic Plan. You can either use the XQuery => chaining operator or specify the variable that captures the return value from the previous operation.
...
/**
    * This method yields one output row set with the rows from an inner join as well as rows from the left row set.  Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.joinLeftOuter|op.joinLeftOuter}
...
/**
    * This method returns a subset of the rows in the result set by skipping the number of rows specified by start and returning the remaining rows up to the number specified by the op:limit method.  Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.offset|op.offset}
...
/**
    * This method returns a subset of the rows in the result set by skipping the number of rows specified by start and returning the remaining rows up to the length limit.  Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.offsetLimit|op.offsetLimit}
...
/**
    ...
    * @since 2.1.1
    * @param { PlanSortKeyName } [keys] - The Optic Plan. You can either use the XQuery => chaining operator or specify the variable that captures the return value from the previous operation.
    * @returns { planBuilder.ModifyPlan }
    */
orderBy(...args) {
...
/**
    ...
    * @since 2.1.1
    * @param { PlanExprColName } [columns] - The Optic Plan. You can either use the XQuery => chaining operator or specify the variable that captures the return value from the previous operation.
...
/**
    * This method yields all of the rows from the input row sets. Columns that are present only in some input row sets effectively have a null value in the rows from the other row sets.  Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.union|op.union}
...
/**
    * This method restricts the row set to rows matched by the boolean expression. Use boolean composers such as op:and and op:or to combine multiple expressions.  Provides a client interface to a server function. See {@link http://docs.marklogic.com/op.where|op.where}
...
/**
    ...
    * @since 2.1.1
    * @param { PlanColumnName } [column] - The name of the column to be defined. This can be either a string or the return value from <a>op:col</a>, <a>op:view-col</a>, or <a>op:schema-col</a>.
...
/**
    ...
    * @since 2.1.1
    * @param { PlanCase } [when] - One or more <a>op:when</a> expressions.
    * @param { Item } [otherwise] - The value expression to return if none of the <a>op:when</a> expressions is <code>true</code>.
    * @returns { Item }
    */
case(...args) {
...
xmlElement(...args) {
    const namer = bldrbase.getNamer(args, 'name');
    const paramdefs = [['name', [types.XsQName, types.XsString, PlanColumn, PlanParam], true, false], ['attributes', [types.AttributeNode, PlanColumn, PlanParam], false, true], ['content', [types.XmlContentNode, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
