...
groupConcat(...args) {
    const namer = bldrbase.getNamer(args, 'name');
    const paramdefs = [['name', [PlanColumn, types.XsString], true, false], ['column', [PlanExprCol, PlanColumn, types.XsString], true, false], ['options', [types.XsString, PlanValueOption], false, true]];
    const checkedArgs = (namer !== null) ?
