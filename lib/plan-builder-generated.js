...
/**
    ...
    * @since 3.6.0
    * @param { PlanExprColName } [start] - The column representing the input starting subject of the shortest path search. The columns can be named with a string or a column parameter function such as op:col.
    * @param { PlanExprColName } [end] - The column representing the input ending object of the shortest path search. The columns can be named with a string or a column parameter function such as op:col.
    * @param { PlanExprColName } [path] - The column is the output column representing the actual shortest path(s) taken from start to end. Values are not returned for this column if this is the empty sequence.The columns can be named with a string or a column parameter function such as op:col.
    * @param { PlanExprColName } [length] - The column is the output column representing the length of the shortest path. Value is not returned for this column if this is the empty sequence.The columns can be named with a string or a column parameter function such as op:col.
...
shortestPath(...args) {
    ...
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanModifyPlan.shortestPath', 2, new Set(['start', 'end', 'path', 'length']), paramdefs, args) :
