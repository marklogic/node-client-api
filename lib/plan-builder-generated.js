...
/**
    * Creates a reference to a field value lexicon, for use as a parameter to <a>cts:value-tuples</a>. Since lexicons are implemented with range indexes, this function will throw an exception if the specified range index does not exist.
    * @method
    * @since 2.1
    * @memberof CtsExpr#
...
/**
    * Returns a query matching fields whose content contains the given phrase. If the specified field does not exist, this function throws an exception. A field is a named object that specified elements to include and exclude from a search, and can include score weights for any included elements. You create fields at the database level using the Admin Interface. For details on fields, see the chapter on "Fields Database Settings" in the <em>Administrator's Guide</em>.
    * @method
    * @since 2.1
    * @memberof CtsExpr#
    * @param { XsString } [fieldName] - One or more field names to search over. If multiple field names are supplied, the match can be in any of the specified fields (or-query semantics).
...
/**
    * Returns a query that matches all documents where <code>$query</code> matches document-properties. When searching documents or document-locks, this query type provides a convenient way to additionally constrain the search against document-properties fragments.
    * @method
    * @since 2.1
    * @memberof CtsExpr#
...
/**
    * Tokenizes text into words, punctuation, and spaces. Returns output in the type <code>cts:token</code>, which has subtypes <code>cts:word</code>, <code>cts:punctuation</code>, and <code>cts:space</code>, all of which are subtypes of <code>xs:string</code>.
    * @method
    * @since 2.1
    * @memberof CtsExpr#
...
/**
    * <p>Adjusts an xs:time value to a specific timezone, or to no timezone at all. If $timezone is the empty sequence, returns an xs:time without a timezone. Otherwise, returns an xs:time with a timezone. </p><p> If $timezone is not specified, then $timezone is the value of the implicit timezone in the dynamic context. </p><p> If $arg is the empty sequence, then the result is the empty sequence. </p><p> A dynamic error is raised [err:FODT0003] if $timezone is less than -PT14H or greater than PT14H or if does not contain an integral number of minutes. </p><p> If $arg does not have a timezone component and $timezone is the empty sequence, then the result is $arg. </p><p> If $arg does not have a timezone component and $timezone is not the empty sequence, then the result is $arg with $timezone as the timezone component. </p><p> If $arg has a timezone component and $timezone is the empty sequence, then the result is the localized value of $arg without its timezone component. </p><p> If $arg has a timezone component and $timezone is not the empty sequence, then: </p><p> Let $srcdt be an xs:dateTime value, with an arbitrary date for the date component and time and timezone components that are the same as the time and timezone components of $arg. </p><p> Let $r be the result of evaluating fn:adjust-dateTime-to-timezone($srcdt, $timezone) </p><p> The result of this function will be a time value that has time and timezone components that are the same as the time and timezone components of $r. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p> Returns the <code>xs:string</code> that is the concatenation of the values of the specified parameters. Accepts two or more <code>xs:anyAtomicType</code> arguments and casts them to <code>xs:string</code>. If any of the parameters is the empty sequence, the parameter is treated as the zero-length string. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Returns the number of items in the value of $arg. </p><p> Returns 0 if $arg is the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Returns an xs:integer between 1 and 31, both inclusive, representing the day component in the localized value of $arg. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p> Returns an xs:integer representing the days component in the canonical lexical representation of the value of $arg. The result may be negative. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p> Returns an xs:integer between 0 and 23, both inclusive, representing the hours component in the localized value of $arg. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Returns an xs:integer representing the hours component in the canonical lexical representation of the value of $arg. The result may be negative. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p> Returns an xs:integer between 0 and 23, both inclusive, representing the value of the hours component in the localized value of $arg. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Returns an xs:integer value between 0 and 59, both inclusive, representing the minute component in the localized value of $arg. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Returns an xs:integer representing the minutes component in the canonical lexical representation of the value of $arg. The result may be negative. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p> Returns an xs:integer value between 0 to 59, both inclusive, representing the value of the minutes component in the localized value of $arg. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Returns an xs:integer between 1 and 12, both inclusive, representing the month component in the localized value of $arg. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Returns an xs:integer representing the months component in the canonical lexical representation of the value of $arg. The result may be negative. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p> Returns an <code>xs:QName</code> value (that is, an expanded QName) by taking an <code>xs:string</code> that has the lexical form of an <code>xs:QName</code> (a string in the form "prefix:local-name" or "local-name") and resolving it using the in-scope namespaces for a given element. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Reverses the order of items in a sequence. If $arg is the empty sequence, the empty sequence is returned. </p><p> For detailed type semantics, see <a>Section 7.2.12 The fn:reverse function[FS]</a>. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Returns an xs:decimal representing the seconds component in the canonical lexical representation of the value of $arg. The result may be negative. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
    * @param { XsDuration } [arg] - The duration whose minute component will be returned.
...
/**
    * <p> Returns the items of $sourceSeq in an implementation dependent order. </p><p> Note: </p><p> Query optimizers may be able to do a better job if the order of the output sequence is not specified. For example, when retrieving prices from a purchase order, if an index exists on prices, it may be more efficient to return the prices in index order rather than in document order. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Returns an xs:integer representing the year component in the localized value of $arg. The result may be negative. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Returns an xs:integer representing the years component in the canonical lexical representation of the value of $arg. The result may be negative. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof FnExpr#
...
/**
    * <p>Returns a linear model that fits the given data set. The size of the input array should be 2, as currently only simple linear regression model is supported. The first element of the array should be the value of the dependent variable while the other element should be the value of the independent variable.</p> <p>The function eliminates all pairs for which either the first element or the second element is empty. After the elimination, if the length of the input is less than 2, the function returns the empty sequence. After the elimination, if the standard deviation of the independent variable is 0, the function returns a linear model with intercept = the mean of the dependent variable, coefficients = NaN and r-squared = NaN. After the elimination, if the standard deviation of the dependent variable is 0, the function returns a linear model with r-squared = NaN.</p> <p>For the version of this function that uses Range Indexes, see <a>cts:linear-model</a>.</p>
    * @method
    * @since 2.1
    * @memberof MathExpr#
    * @param { JsonArray } [arg] - The input data set. Each array should contain a pair of values.
...
class RdfExpr {
  ...
  /**
    * Returns an <code>rdf:langString</code> value with the given value and language tag. The <code>rdf:langString</code> type extends <code>xs:string</code>, and represents a language tagged string in RDF. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof RdfExpr#
...
/**
    * Returns the language of an <code>rdf:langString</code> value. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof RdfExpr#
...
class SemExpr {
  ...
  /**
    * This function returns an identifier for a blank node, allowing the construction of a triple that refers to a blank node. This XQuery function backs up the SPARQL BNODE() function. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Returns the value of the first argument that evaluates without error. This XQuery function backs up the SPARQL COALESCE() functional form. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * The IF function form evaluates the first argument, interprets it as a effective boolean value, then returns the value of expression2 if the EBV is true, otherwise it returns the value of expression3. Only one of expression2 and expression3 is evaluated. If evaluating the first argument raises an error, then an error is raised for the evaluation of the IF expression. This XQuery function backs up the SPARQL IF() functional form. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Returns a <code>sem:invalid</code> value with the given literal value and datatype IRI. The <code>sem:invalid</code> type extends <code>xs:untypedAtomic</code>, and represents an RDF value whose literal string is invalid according to the schema for it's datatype. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
    * @param { XsString } [string] - The lexical value.
...
/**
    * Returns the datatype IRI of a <code>sem:invalid</code> value. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Returns true if the argument is an RDF blank node - that is, derived from type <code>sem:blank</code>. This XQuery function backs up the SPARQL isBlank() function. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Returns true if the argument is an RDF IRI - that is, derived from type <code>sem:iri</code>, but not derived from type <code>sem:blank</code>. This XQuery function backs up the SPARQL isIRI() and isURI() functions. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
    * @param { XsAnyAtomicType } [value] - The value to test.
...
/**
    * Returns true if the argument is an RDF literal - that is, derived from type <code>xs:anyAtomicType</code>, but not derived from type <code>sem:iri</code>. This XQuery function backs up the SPARQL isLiteral() function. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
    * @param { XsAnyAtomicType } [value] - The value to test.
...
/**
    * Returns true if the argument is a valid numeric RDF literal. This XQuery function backs up the SPARQL isNumeric() function. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
    * @param { XsAnyAtomicType } [value] - The value to test.
...
/**
    * Returns the language of the value passed in, or the empty string if the value has no language. Only values derived from <code>rdf:langString</code> have a language. This XQuery function backs up the SPARQL lang() function. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Returns true if <code>$lang-tag</code> matches <code>$lang-range</code> according to the basic filtering scheme defined in RFC4647. This XQuery function backs up the SPARQL langMatches() function. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Returns a random double between 0 and 1. This XQuery function backs up the SPARQL RAND() function. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Returns true if the arguments are the same RDF term as defined by the RDF concepts specification. This XQuery function backs up the SPARQL sameTerm() function. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * The <code>sem:store</code> function defines a set of criteria, that when evaluated, selects a set of triples to be passed in to <code>sem:sparql()</code>, <code>sem:sparql-update()</code>, or <code>sem:sparql-values()</code> as part of the options argument. The <code>sem:store</code> constructor queries from the current database's triple index, restricted by the options and the <code>cts:query</code> argument (for instance, "triples in documents matching this query"). <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Returns the timezone of an <code>xs:dateTime</code> value as a string. This XQuery function backs up the SPARQL TZ() function. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Returns a <code>sem:unknown</code> value with the given literal value and datatype IRI. The <code>sem:unknown</code> type extends <code>xs:untypedAtomic</code>, and represents an RDF value with a datatype IRI for which no schema is available. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
    * @param { XsString } [string] - The lexical value.
...
/**
    * Returns the datatype IRI of a <code>sem:unknown</code> value. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Return a UUID URN (RFC4122) as a <code>sem:iri</code> value. This XQuery function backs up the SPARQL UUID() function. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Return a string that is the scheme specific part of random UUID URN (RFC4122). This XQuery function backs up the SPARQL STRUUID() function. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SemExpr#
...
/**
    * Returns an <code>rdf:collatedString</code> value with the given value and collation tag. The <code>rdf:collatedString</code> type extends <code>xs:string</code> , and represents a collation tagged string in RDF. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof SqlExpr#
    * @param { XsString } [string] - The lexical value.
...
/**
    * <p>Returns a specified date with the specified number interval (signed integer) added to a specified datepart of that date </p>
    * @method
    * @since 2.1
    * @memberof SqlExpr#
...
/**
    * <p>Returns the count (signed integer) of the specified datepart boundaries crossed between the specified startdate and enddate. </p>
    * @method
    * @since 2.1
    * @memberof SqlExpr#
...
/**
    * <p>Returns an integer that represents the specified <code>datepart</code> of the specified <code>date</code>. </p><p> If <code>datepart</code> or <code>date</code> is the empty sequence, the function returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof SqlExpr#
...
/**
    * <p>Returns an xs:string representing the dayname value in the localized value of $arg. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof SqlExpr#
...
/**
    * <p> Returns month name, calculated from the localized value of $arg. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof SqlExpr#
...
/**
    * <p> Returns an xs:integer between 1 and 4, both inclusive, calculating the quarter component in the localized value of $arg. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof SqlExpr#
...
/**
    * <p> Returns an xs:integer between 1 and 53, both inclusive, representing the week value in the localized value of $arg. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof SqlExpr#
...
/**
    * <p>Returns an xs:integer between 1 and 366, both inclusive, representing the yearday value in the localized value of $arg. </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof SqlExpr#
...
/**
    * Returns the name of the simple type of the atomic value argument as an <code>xs:QName</code>. <p>This function is a built-in.</p>
    * @method
    * @since 2.1
    * @memberof XdmpExpr#
    * @param { XsAnyAtomicType } [value] - The value to return the type of.
...
/**
    * <p>Converts plaintext into URL-encoded string. To decode the string, use <a>xdmp:url-decode</a>.</p> <p>There is also a W3C function that does a slightly different url encoding: <a>fn:encode-for-uri</a>.</p>
    * @method
    * @since 2.1
    * @memberof XdmpExpr#
    * @param { XsString } [plaintext] - Plaintext to be encoded.
...
/**
    * <p>Returns an xs:integer in the range 1 to 7, inclusive, representing the weekday value in the localized value of $arg. Monday is the first weekday value (value of 1), and Sunday is the last (value of 7). </p><p> If $arg is the empty sequence, returns the empty sequence. </p>
    * @method
    * @since 2.1
    * @memberof XdmpExpr#
...
/**
    * This method applies a function or the builtin reducer to each row returned by the plan to produce a single result as with the <code>reduce()</code> method of JavaScript Array. <p> The signature of the reducer must be <code>function(previous, row)</code>, where <code>previous</code> is the seed on the first request and the return from the previous call on subsequent request and <code>row</code> is the current row. </p> <p> The implementation of a <code>op:reduce</code> function can call <a>op:map</a> functions to chain map calls with reduce calls. </p>
    * @method
    * @since 2.1
    * @memberof PlanPreparePlanExpr#
    * @param { PlanFunction } [func] - The Optic Plan. You can either use the XQuery => chaining operator or specify the variable that captures the return value from the previous operation.
...
/**
    * This method yields all of the rows from the input row sets. Columns that are present only in some input row sets effectively have a null value in the rows from the other row sets. <p> This method is often followed by the <a>op:where-distinct</a> modifier. </p>
    * @method
    * @since 2.1
    * @memberof PlanModifyPlanExpr#
    * @param { PlanModifyPlan } [right] - The row set from the left view.
...
this.xs = (fieldOverrides.xs !== void 0) ? fieldOverrides.xs : new XsExpr();
  ...
  /**
    * This function returns the sum of the specified numeric expressions. In expressions, the call should pass the result from an <a>op:col</a> function to identify a column. <p> The <a>op:add</a> function differs from the <a>op:sum</a> function in that it operates on operates on multiple column values in a row, rather than a group of rows. </p><p> As a convenience, you can pass a sequence of any number of expressions as the first argument: <code>op:add((expr1, expr2, ..., exprN))</code> </p>
    * @method
    * @since 2.1
    * @memberof PlanBuilder#
...
/**
    * This function returns <code>true</code> if the specified expressions all return <code>true</code>. Otherwise, it returns <code>false</code>. You can either compair <p> As a convenience, you can pass a sequence of any number of expressions as the first argument: <code>op:and((expr1, expr2, ..., exprN))</code> </p>
    * @method
    * @since 2.1
    * @memberof PlanBuilder#
...
/**
    * This function multipies the left <code>numericExpression</code> by the right <code>numericExpression</code> and returns the value. <p> As a convenience, you can pass a sequence of any number of expressions as the first argument: <code>op:multiply((expr1, expr2, ..., exprN))</code> </p>
    * @method
    * @since 2.1
    * @memberof PlanBuilder#
    * @param { XsNumeric } [left] - The left numeric expression.
...
/**
    * This function returns <code>true</code> if the specified expressions all return <code>true</code>. Otherwise, it returns <code>false</code>. <p> As a convenience, you can pass a sequence of any number of expressions as the first argument: <code>op:or((expr1, expr2, ..., exprN))</code> </p>
    * @method
    * @since 2.1
    * @memberof PlanBuilder#
    * @param { XsAnyAtomicType } [left] - The left value expression.
...
/**
    * Identifies a column where the combination of view and column name is unique. Identifying the schema isn't necessary (and it might not exist). <p> If the combination of view and column name is not unique, an ambiguous column error is thrown. </p>
    * @method
    * @since 2.1
    * @memberof PlanBuilder#
    * @param { XsString } [view] - The name of the view.
...
/**
    * <p> This function reads a row set from a configured view over TDE-indexed rows or a predefined view over range indexes. <p> This function creates a row set without a limit. Use <a>op:limit</a> or <a>op:offset-limit</a> to set a limit. </p> </p>
    * @method
    * @since 2.1
    * @memberof PlanBuilder#
...
/**
    * Specifies an equijoin using one columndef each from the left and right rows. The result is used by the <a>op:join-inner</a> and <a>op:join-left-outer</a> functions. <p> Use <a>op:view-col</a> or <a>op:col</a> if you need to identify columns in the two views that have the same column name. </p>
    * @method
    * @since 2.1
    * @memberof PlanBuilder#
...
/**
    * This function adds the non-null values of the column for the rows in the group or row set. The result is used for building the parameters used by the <a>op:group-by</a> function. <p> The <a>op:sum</a> function differs from the <a>op:add</a> function in that it operates on operates on a group of rows, rather than multiple column values in a row. </p>
    * @method
    * @since 2.1
    * @memberof PlanBuilder#
    * @param { PlanColumn } [name] - The name to be used for the aggregated column.
