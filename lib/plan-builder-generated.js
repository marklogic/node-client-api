...
/**
    ...
    * @param { PlanColumn } [fragmentIdCol] - The document uri. This is the output from op:col('uri') that specifies a document uri column.
    * @returns { planBuilder.ModifyPlan }
    */
joinDocUri(...args) {
...
/**
    ...
    * @param { XsBoolean } [condition] - The equijoin from one or more calls to the op:on function.
    * @returns { planBuilder.ModifyPlan }
    */
joinInner(...args) {
    const namer = bldrbase.getNamer(args, 'right');
