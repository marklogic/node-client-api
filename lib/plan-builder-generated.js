...
coveredBy(...args) {
    ...
    const paramdefs = [['arg1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg3', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.coveredBy', 2, new Set(['arg1', 'arg2', 'arg3']), paramdefs, args) :
...
covers(...args) {
    ...
    const paramdefs = [['arg1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg3', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.covers', 2, new Set(['arg1', 'arg2', 'arg3']), paramdefs, args) :
...
/**
    ...
    */
remove(...args) {
    const paramdef = ['doc-cols', [PlanDocColsIdentifier, PlanColumn, types.XsString], false, false];
...
transformDoc(...args) {
    ...
    const paramdefs = [['transformed', [PlanDocColsIdentifier, PlanColumn, types.XsString], true, false], ['transformDef', [PlanTransformDef], true, false]];
    const checkedArgs = (namer !== null) ?
...
validateDoc(...args) {
    ...
    const paramdefs = [['validated', [PlanColumn, types.XsString], true, false], ['schemaDef', [PlanSchemaDef], true, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanModifyPlan.validateDoc', 2, new Set(['validated', 'schemaDef']), paramdefs, args) :
...
/**
    ...
    * @since 2.1.1
    * @param { PlanDocDescriptor } [docDescriptor] - 
    * @param { XsString } [qualifier] - 
    * @returns { planBuilder.AccessPlan }
    */
