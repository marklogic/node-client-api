...
geospatialRegionPathReference(...args) {
    const namer = bldrbase.getNamer(args, 'path-expression');
    const paramdefs = [['path-expression', [types.XsString], true, false], ['options', [types.XsString], false, true], ['namespaces', [types.MapMap], false, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'cts.geospatialRegionPathReference', 1, new Set(['path-expression', 'options', 'namespaces']), paramdefs, args) :
...
/**
    ...
    * @since 2.1.1
    * @param { CtsRegion } [arg1] - 
    * @param { CtsRegion } [arg2] - 
    * @param { XsString } [arg3] - 
    * @returns { XsBoolean }
    */
contains(...args) {
    const namer = bldrbase.getNamer(args, 'arg1');
    const paramdefs = [['arg1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg3', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.contains', 2, new Set(['arg1', 'arg2', 'arg3']), paramdefs, args) :
...
crosses(...args) {
    ...
    const paramdefs = [['arg1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg3', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.crosses', 2, new Set(['arg1', 'arg2', 'arg3']), paramdefs, args) :
...
disjoint(...args) {
    ...
    const paramdefs = [['arg1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg3', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.disjoint', 2, new Set(['arg1', 'arg2', 'arg3']), paramdefs, args) :
...
equals(...args) {
    ...
    const paramdefs = [['arg1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg3', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.equals', 2, new Set(['arg1', 'arg2', 'arg3']), paramdefs, args) :
...
intersects(...args) {
    ...
    const paramdefs = [['arg1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg3', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.intersects', 2, new Set(['arg1', 'arg2', 'arg3']), paramdefs, args) :
...
overlaps(...args) {
    ...
    const paramdefs = [['arg1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg3', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.overlaps', 2, new Set(['arg1', 'arg2', 'arg3']), paramdefs, args) :
...
touches(...args) {
    ...
    const paramdefs = [['arg1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg3', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.touches', 2, new Set(['arg1', 'arg2', 'arg3']), paramdefs, args) :
...
within(...args) {
    ...
    const paramdefs = [['arg1', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg2', [types.CtsRegion, PlanColumn, PlanParam], true, false], ['arg3', [types.XsString, PlanColumn, PlanParam], false, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'geo.within', 2, new Set(['arg1', 'arg2', 'arg3']), paramdefs, args) :
...
/**
    * Constructs json:array from a sequence of items. Provides a client interface to a server function. See {@link http://docs.marklogic.com/json:to-array|json:to-array}
...
/**
    ...
    * @param { XsString } [escape] - If a '_' or '%' are preceeded by an escape character then it will be match as the char '-'/'%' themselves.
    * @returns { XsBoolean }
    */
like(...args) {
    const namer = bldrbase.getNamer(args, 'input');
...
class PlanErrorDisposition extends types.ServerType {
...
/**
    ...
    * @since 2.1.1
    * @param { PlanDocIdentifier } [docCols] - 
    * @returns { planBuilder.ModifyPlan }
    */
remove(...args) {
    const paramdef = ['doc-cols', [PlanDocColsIdentifier, PlanColumnName], false, false];
...
/**
    ...
    * @since 2.1.1
    * @param { PlanDocIdentifier } [transformed] - 
    * @param { PlanTransformDef } [transformDef] - 
    * @returns { planBuilder.ModifyPlan }
    */
transformDoc(...args) {
    const namer = bldrbase.getNamer(args, 'transformed');
    const paramdefs = [['transformed', [PlanDocColsIdentifier, PlanColumnName], true, false], ['transformDef', [PlanTransformDef], true, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanModifyPlan.transformDoc', 2, new Set(['transformed', 'transformDef']), paramdefs, args) :
...
/**
    ...
    */
joinDocCols(...args) {
    const namer = bldrbase.getNamer(args, 'doc-cols');
    const paramdefs = [['doc-cols', [PlanDocColsIdentifier], false, false], ['doc-id-col', [PlanColumn, types.XsString], true, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanModifyPlan.joinDocCols', 2, new Set(['doc-cols', 'doc-id-col']), paramdefs, args) :
...
/**
    ...
    * @since 2.1.1
    * @param { PlanColumnName } [validated] - 
    * @param { PlanSchemaDef } [schemaDef] - 
    * @param { PlanErrorDisposition } [errorDisposition] - 
    * @returns { planBuilder.ModifyPlan }
    */
validateDoc(...args) {
    const namer = bldrbase.getNamer(args, 'validated');
    const paramdefs = [['validated', [PlanColumn, types.XsString], true, false], ['schemaDef', [PlanSchemaDef], true, false], ['errorDisposition', [PlanErrorDisposition], true, false]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanModifyPlan.validateDoc', 3, new Set(['validated', 'schemaDef', 'errorDisposition']), paramdefs, args) :
        bldrbase.makePositionalArgs('PlanModifyPlan.validateDoc', 3, false, paramdefs, args);
...
/**
    ...
    * @since 2.1.1
    * @param { PlanExprColName } [inputColumn] - 
    * @param { PlanExprColName } [valueColumn] - 
    * @param { PlanExprColName } [ordinalColumn] - 
    * @returns { planBuilder.ModifyPlan }
    */
unnestInner(...args) {
...
/**
    ...
    * @since 2.1.1
    * @param { PlanQueryDef } [querydef] - 
    * @param { XsString } [qualifier] - 
    * @returns { planBuilder.AccessPlan }
    */
fromDocUris(...args) {
...
/**
    ...
    * @param { XsString } [qualifierName] - Specifies a name for qualifying the column names. Placeholder parameters in the SPARQL string may be bound in the result() call
...
/**
    ...
    * @since 2.1.1
    * @param { XsString } [paramName] - 
    * @param { XsString } [qualifier] - 
    * @param { PlanRowColTypes } [colTypes] - 
    * @returns { planBuilder.AccessPlan }
    */
fromParam(...args) {
    const namer = bldrbase.getNamer(args, 'param-name');
    const paramdefs = [['param-name', [types.XsString], true, false], ['qualifier', [types.XsString], false, false], ['col-types', [PlanRowColTypes], true, true]];
    const checkedArgs = (namer !== null) ?
        bldrbase.makeNamedArgs(namer, 'PlanBuilder.fromParam', 3, new Set(['param-name', 'qualifier', 'col-types']), paramdefs, args) :
