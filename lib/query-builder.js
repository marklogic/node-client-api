 ...
 */
/**
 * A binding for parsing a query string; the binding declares a constraint name
 * that tags the values in the query string and occupies the position of the
 * values in a query.
 * @typedef {object} queryBuilder.Binding
 */
/**
 ...
 * @typedef {object} queryBuilder.FragmentScope
 */
 ...
 * @method
 * @memberof queryBuilder#
 * @param {string|string[]|queryBuilder.Binding} collections - either
 ...
 * @param {queryBuilder.Query|queryBuilder.Binding} query - either the
 ...
 * @param {queryBuilder.Query} matchingQuery - a query that must match
 * the result documents
 * @param {queryBuilder.FragmentScope} [fragmentScope] - whether the query
 ...
 * @returns {queryBuilder.FragmentScope} a datatype specification
 */
function datatype() {
  var args = mlutil.asArray.apply(null, arguments);
  switch(args.length) {
 ...
 * @returns {queryBuilder.FragmentScope} a fragment scope specification 
 */
 ...
 * prefix
 * @returns {queryBuilder.Binding} the binding for the constraint name
 */
function bind() {
