...
function AndDef(queryList) {
  ...
  if (!valcheck.isNullOrUndefined(queryList)) {
    if (queryList instanceof QueryListDef) {
      ...
      throw new Error('invalid and() query');
    }
  } else {
...
function QueryListDef(queries, ordered, weight, distance) {
  ...
  if (valcheck.isArray(queries)) {
    ...
    throw new Error('invalid query list');
  }
  ...
  if (!valcheck.isNullOrUndefined(ordered)) {
    if (valcheck.isBoolean(ordered)) {
      ...
      throw new Error('invalid order for query list: '+ordered);
    }
  }
  ...
  if (!valcheck.isNullOrUndefined(weight)) {
    if (valcheck.isNumber(weight)) {
      ...
      throw new Error('invalid weight for query list: '+weight);
    }
  }
  ...
  if (!valcheck.isNullOrUndefined(distance)) {
    if (valcheck.isNumber(distance)) {
      ...
      throw new Error('invalid distance for query list: '+distance);
    }
  }
}
/**
...
function andNot() {
  ...
  default:
    throw new Error('too many arguments for andNot(): '+args.length);
  }
}
/** @ignore */
function AndNotDef(positiveNegative) {
  ...
  if (positiveNegative instanceof PositiveNegativeDef) {
    ...
    throw new Error('invalid andNot() query');
  }
}
/** @ignore */
...
function BoostDef(matchingBoosting) {
  ...
  if (matchingBoosting instanceof MatchingBoostingDef) {
    ...
    throw new Error('invalid boost() query');
  }
}
/** @ignore */
...
function collection() {
  ...
  if (!valcheck.isNullOrUndefined(constraintName)) {
    if (i < argLen) {
      throw new Error('collection has both query and binding: '+args.join(', '));
    }
  ...
  if (!valcheck.isNullOrUndefined(suggestOptions)) {
    throw new Error('collection has both query and suggest options: '+args.join(', '));
  }
...
function CollectionConstraintDef(constraintName, suggestOptions, qualifierDef) {
  ...
  if (constraintName === null && suggestOptions === null && qualifierDef === null) {
    ...
    if (qualifierDef instanceof CollectionQualifierDef) {
      ...
      throw new Error('invalid qualifier definition for collection binding: '+qualifierDef);
    }
...
function CollectionQualifierDef(prefix) {
  ...
  if (valcheck.isString(prefix)) {
    ...
    throw new Error('invalid prefix for collection binding: '+prefix);
  }
}
/** @ignore */
function CollectionQueryDef(uriList) {
  ...
  if (uriList instanceof UrisDef) {
    ...
    throw new Error('invalid uri list for collection(): '+uriList);
  }
}
/**
...
function lsqtQuery() {
  ...
  for (var i=0; i < args.length; i++) {
    ...
    throw new Error('unknown argument for lsqt query: '+arg);
  }
...
function LSQTDef(queryDef) {
  ...
  if (queryDef instanceof LSQTQueryDef) {
    ...
    throw new Error('invalid LSQT query definition: '+queryDef);
  }
}
/** @ignore */
function LSQTQueryDef(temporalCollection, weight, timestamp, temporalOptions) {
  ...
  if (valcheck.isString(temporalCollection)) {
    ...
    throw new Error('invalid temporal collection: '+temporalCollection);
  }
  if (!valcheck.isNullOrUndefined(weight)) {
    if (valcheck.isNumber(weight)) {
      this.weight = weight;
...
function scope() {
  ...
  for (var i=0; i < args.length; i++) {
    ...
    throw new Error('unknown argument for scope: '+arg);
  }

  if (!valcheck.isNullOrUndefined(query)) {
    if (!valcheck.isNullOrUndefined(constraintName)) {
      throw new Error('scope has both binding and query: '+args.join(', '));
    }
...
function ContainerConstraintDef(constraintName, containedDef) {
  ...
  if (valcheck.isString(constraintName)) {
    ...
    throw new Error('invalid constraint name for container: '+constraintName);
  }
  if (containedDef instanceof ContainedDef) {
    ...
    throw new Error('invalid contained definition for container binding: '+containedDef);
  }
}
/** @ignore */
function ContainerQueryDef(containedDef) {
  ...
  if (containedDef instanceof ContainedDef) {
    ...
    throw new Error('invalid contained definition for container query: '+containedDef);
  }
}
/** @ignore */
...
function DirectoryQueryDef(uriList) {
  ...
  if (uriList instanceof UrisDef) {
    ...
    throw new Error('invalid uri list for directory(): '+uriList);
  }
}
/**
...
function DocumentDef(uriList) {
  ...
  if (uriList instanceof UrisDef) {
    ...
    throw new Error('invalid uri list for document(): '+uriList);
  }
}
/** @ignore */
function UrisDef(uris, infinite) {
  ...
  if (!valcheck.isArray(uris)) {
    throw new Error('invalid uri list: '+uris);
  ...
  if (!valcheck.isNullOrUndefined(infinite)) {
    if (!valcheck.isBoolean(infinite)) {
      throw new Error('infinite flag must be boolean: '+infinite);
    } else {
...
function FieldNameDef(name, collation) {
  ...
  if (valcheck.isString(name)) {
    ...
    throw new Error('invalid name for field: '+name);
  }
  if (valcheck.isString(collation)) {
    this.collation = collation;
  } else  if (!valcheck.isNullOrUndefined(collation)) {
    throw new Error('invalid collation for field: '+collation);
  }
}
/**
...
function geospatial() {
  ...
  for (; i < args.length; i++) {
    ...
    if (i === 0) {
      ...
      throw new Error('unknown geospatial location: '+firstKey);
    }
    ...
    throw new Error('unknown geospatial argument: '+arg);
  }

  var wrapper = {};
  if (seekingRegion === false) {
    if (!valcheck.isNullOrUndefined(constraintName)) {
      throw new Error(variant+' has both query and binding: '+args.join(', '));
    }
    if (!valcheck.isNullOrUndefined(suggestOptions)) {
      throw new Error(variant+' has both query and suggest options: '+args.join(', '));
    }
...
function NearDef(queryList) {
  ...
  if (queryList instanceof QueryListDef) {
    ...
    throw new Error('invalid near() query');
  }
}
/**
...
function NotInDef(positiveNegative) {
  ...
  if (positiveNegative instanceof PositiveNegativeDef) {
    ...
    throw new Error('invalid notIn() query');
  }
}
/**
...
function OrDef(queryList) {
  ...
  if (!valcheck.isNullOrUndefined(queryList)) {
    if (queryList instanceof QueryListDef) {
      ...
      throw new Error('invalid or query');
    }
  } else {
...
function OrderedDef(on) {
  ...
  if (valcheck.isBoolean(on)) {
    ...
    throw new Error('invalid order parameter: '+on);
  }
}
/**
 ...
 */
function properties() {  
  return new PropertiesDef(mlutil.first.apply(null, arguments));
}
/** @ignore */
function PropertiesDef(query) {
  if (!(this instanceof PropertiesDef)) {
    return new PropertiesDef(query);
  }

  if (!valcheck.isNullOrUndefined(query)) {
    this['properties-query'] = checkQuery(query);
  } else {
    throw new Error('missing query');
  }
}
...
function PeriodDef(startDate, endDate) {
  ...
  if (valcheck.isString(startDate)) {
    ...
    throw new Error('invalid start date for period: '+startDate);
  }
  if (valcheck.isString(endDate)) {
    ...
    throw new Error('invalid end date for period: '+endDate);
  }
}
/**
...
function periodCompare() {
  ...
  for (var i=0; i < argLen; i++) {
    ...
    throw new Error('unknown period compare argument: '+arg);
  }
...
function PeriodCompareDef(queryDef) {
  ...
  if (queryDef instanceof PeriodCompareQueryDef) {
    ...
    throw new Error('invalid period compare query: '+queryDef);
  }
}
/** @ignore */
...
function periodRange() {
  ...
  for (var i=0; i < argLen; i++) {
    ...
    throw new Error('unknown period range argument: '+arg);
  }
...
function PeriodRangeDef(queryDef) {
  ...
  if (queryDef instanceof PeriodRangeQueryDef) {
    ...
    throw new Error('invalid period range query: '+queryDef);
  }
}
/** @ignore */
...
function range() {
  ...
  if (values !== null) {
    if (!valcheck.isNullOrUndefined(constraintName) || defaultConstraint === true) {
      throw new Error('range has both query and binding: '+args.join(', '));
    }
    if (!valcheck.isNullOrUndefined(suggestOptions)) {
      throw new Error('range has both query and suggest options: '+args.join(', '));
    }
...
function WeightDef(number) {
  ...
  if (valcheck.isNumber(number) && -16 <= number && number <= 64) {
    ...
    throw new Error('invalid weight: '+number);
  }
}
/**
...
function slice() {
  ...
  for (var i=0; i < argLen; i++) {
    ...
    if (valcheck.isNumber(arg)) {
      ...
      throw new Error('unknown slice argument: '+arg);
    }
  }
...
function facet() {
  ...
  for (var i=0; i < argLen; i++) {
    ...
    throw new Error('unknown facet argument: '+arg);
  }
  if (constraintIndex === null) {
...
function parsedFrom() {
  ...
  case 2:
    ...
    break;
  default:
    throw new Error('parse from specifies only query text and bindings: '+args.join(', '));
  }
...
function ParsedDef(queryDef) {
  ...
  if (queryDef instanceof ParsedQueryDef) {
    ...
    throw new Error('invalid query definition to parse from: '+queryDef);
  }
}
/** @ignore */
function ParsedQueryDef(qtext, constraints, term) {
  ...
  if (valcheck.isString(qtext)) {
    ...
    throw new Error('invalid query text to parse from: '+qtext);
  }
  if (valcheck.isArray(constraints)) {
    ...
    throw new Error('invalid constraints to parse from: '+constraints);
  }
...
function makeBindings(variant, args) {
  ...
  for (var i=0; i < argLen; i++) {
    ...
    throw new Error('unknown argument for parse query binding: '+arg);
  }
...
function BindingsDef(constraints, termDef) {
  ...
  if (valcheck.isArray(constraints) && constraints.length > 0) {
    ...
    throw new Error('invalid constraints list for parse query binding: '+constraints);
  }
  if (termDef instanceof TermBindingDef) {
    this.term = termDef;
  } else if (!valcheck.isNullOrUndefined(termDef)) {
    throw new Error('invalid term bindings for parse query binding: '+termDef);
  }
}
/** @ignore */
...
function BindDef(name) {
  ...
  if (valcheck.isString(name)) {
    ...
    throw new Error('cannot bind invalid name to constraint: '+name);
  }
}
/**
...
function BindEmptyDef(applyDef) {
  ...
  if (applyDef instanceof EmptyApplyDef) {
    ...
    throw new Error('cannot bind invalid name to constraint: '+applyDef);
  }
}
/** @ignore */
function EmptyApplyDef(binding) {
  ...
  if (valcheck.isString(binding) && valid[binding] === true) {
    ...
    throw new Error('unknown binding specified for empty input: '+binding);
  }
}
/**
...
function parseFunction() {
  ...
  for (var i=1; i < args.length; i++) {
    ...
    throw new Error('unknown argument for parse function: '+arg);
  }
...
function CustomConstraintDef(constraintName, constraintDef) {
  ...
  if (constraintDef instanceof CustomOptionsDef) {
    ...
    throw new Error('invalid constraint definition for query parse function: '+constraintDef);
  }
}
/** @ignore */
function CustomOptionsDef(parserDef, termOptions) {
  ...
  if (parserDef instanceof CustomParserDef) {
    ...
    throw new Error('invalid parser definition for query parse function: '+parserDef);
  }
  if (!valcheck.isNullOrUndefined(termOptions)) {
    this['term-option'] = termOptions;
  }
...
function snippet() {
  ...
  for (var i=0; i < argLen; i++) {
    ...
    throw new Error('unknown argument for snippet: '+arg);
  }
