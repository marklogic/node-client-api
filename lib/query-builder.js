 ...
 * @method
 * @memberof queryBuilder#
 * @param {string, number or date} - referring to the time to find fragments committed before this
 * @returns {queryBuilder.Query} a composable query
 */
function before() {
   var args = mlutil.asArray.apply(null, arguments);
 ...
 * @method
 * @memberof queryBuilder#
 * @param {string, number or date} - referring to the time to find fragments committed after this
 * @returns {queryBuilder.Query} a composable query
 */
function after() {
  var args = mlutil.asArray.apply(null, arguments);
