...
function geoPath() {
  ...
  } else if (args.length === 2 && (typeof args[0] === 'string' || args[0] instanceof String)) {
...
function orderBy() {
  ...
  for (var i=0; i < args.length; i++) {
    arg = args[i];
    sortOrder.push((typeof arg === 'string' || arg instanceof String) ? sort(arg) : arg);
  }
...
function slice() {
  ...
  for (var i=0; i < argLen; i++) {
    ...
    } else if (arg['transform-results'] !== void 0) {
