...
function queryRowsImpl(self, builtPlan, streamType, options, bindingArg) {
  const operation = queryRowsOperationImpl(self, builtPlan, streamType, options, bindingArg);
...
function queryRowsOperationImpl(self, builtPlan, streamType, options, bindingArg) {
  let sep = '?',
  ...
  if (bindingArg) {
    const bindingKey = Object.keys(bindingArg)[0];
