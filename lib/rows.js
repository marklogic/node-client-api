...
function queryRowsOperationImpl(self, builtPlan, streamType, options, bindingArg, graphqlQuery) {
 ...
 // console.log(builtPlan['_fn'])
  console.log(options)
  let updateFunctions = new Set().add('write').add('lock-for-update').add('remove');
  let isUpdateFunction = builtPlan?updateFunctions.has(builtPlan['_fn']):null;
  console.log(isUpdateFunction)
 // console.log(builtPlan['_fn'])
  let sep = '?',
 ...
 // let endpoint = graphqlQuery?'/v1/rows/graphql':'/v1/rows';
  let endpoint = graphqlQuery?'/v1/rows/graphql':(isUpdateFunction?'/v1/rows/update':'/v1/rows');
console.log(endpoint)
  ...
  if (bindingArg) {
   ...
   // const endpoint = '/v1/rows';
    const endpoint = isUpdateFunction?'/v1/rows/update':'/v1/rows';
