...
/**
 * The removeAllUris function deletes request for all the documents from each batch.
 * The options include TBD.
 * @method documents#removeAllUris
 * @since 2.10.0
 * @param {object} [options] - Configures the removeAllUris operation.
 * @returns {stream.Writable} - returns a writable stream that receives document URI input from the application in
 * string mode or (for arrays of strings) object mode
 */
...
/**
 * The queryToRemoveAll is a convenience function that combines the query and removeALlUris operations.
