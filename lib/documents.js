...
function checkDocument() {
  ...
  var operation = mlrest.createOperation(
      this.client, requestOptions, 'empty', 'empty'
      );
  operation.uri              = uri;
...
// TODO: set format to JSON only if metadata, set flag to force mapping
  ...
  var operation = mlrest.createOperation(
      this.client, requestOptions, 'empty', 'multipart'
      );
  operation.uris       = uris;
...
function createReadStream() {
  ...
  var operation = mlrest.createOperation(
      this.client, requestOptions, 'empty', 'chunked'
      );
  operation.uri = uri;
...
function createWriteStream(document) {
  ...
  var operation = mlrest.createOperation(
      this.client, requestOptions, 'chunked', 'single'
      );
...
function writeDocuments() {
  ...
  var operation = mlrest.createOperation(
      this.client, requestOptions, 'multipart', 'single'
      );
...
function queryDocuments(queryBuilder) {
  ...
  var operation = mlrest.createOperation(
      this.client, requestOptions, 'single',
...
function patchDocuments() {
  ...
  var operation = mlrest.createOperation(
      this.client, requestOptions, 'single', 'single'
      );
