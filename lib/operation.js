...
Operation.prototype.copyResponseHeaders = function copyResponseHeaders(response) {
  ...
  if (valcheck.isNullOrUndefined(format) && contentType !== null) {
...
function OperationHeaders(
  ...
  this.contentLength =
    (valcheck.isNullOrUndefined(contentLength) || contentLength === 0) ?
    null : contentLength;
  ...
  this.location   = valcheck.isNullOrUndefined(location)   ? null : location;
  this.systemTime = valcheck.isNullOrUndefined(systemTime) ? null : systemTime;
}
