...
class EndpointCaller {
  constructor(client, endpointDeclaration) {
    ...
    const endpointDirectory = endpoint.endpointDirectory;
    this.functionName = endpoint.functionName;
    endpointDeclaration.functionName = this.functionName;

    const endpointDirectoryLiteral = {endpointDirectory: endpointDirectory};
