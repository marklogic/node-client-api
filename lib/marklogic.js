...
// TODO: jsDoc for config.patch.replace, config.query.custom, config.query.snippet
...
// TODO: jsdoc for types
   ...
   * with SPARQL on named triple graphs.
   * @name graphs
   * @memberof! DatabaseClient#
   * @type {graphs} 
   */
...
/**
 * Creates one or more documents; takes a collection name string and the
 * content for one or more documents (or an array of content). The
