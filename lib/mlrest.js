...
function ResponseProxy(mapper, hasSingleResult, requestdef, minErrorStatus) {
  events.EventEmitter.call(this);
  this.data            = null;
  this.error           = null;
  this.resolve         = null;
...
function createResponse(mapper, hasSingleResult, requestdef, minErrorStatus) {
  return new ResponseProxy(mapper, hasSingleResult, requestdef, minErrorStatus);
}
