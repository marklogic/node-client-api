...
function ResponseProxy(mapper, hasSingleResult, requestdef) {
  events.EventEmitter.call(this);
  this.data            = null;
  this.error           = null;
  this.resolve         = null;
...
function createResponse(eventNames, hasSingleResult, requestdef) {
  return new ResponseProxy(eventNames, hasSingleResult, requestdef);
}
