...
/**
  * This function creates a placeholder for a cts query value bound at request time, for use as a
  * sub-query or argument within a cts query tree (e.g. cts.andQuery, cts.orQuery, cts.wordQuery,
  * cts.collectionQuery). Distinct from planBuilder#param, which creates an op-namespaced placeholder.
  * @method planBuilder.cts#param
  * @since 4.2.0
