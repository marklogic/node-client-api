...
function databaseParam(connectionParams, endpoint, separator) {
  ...
  if (database == null) {
    if(connectionParams.basePath) {
      let basePath = connectionParams.basePath.toString().startsWith('/') ? connectionParams.basePath.toString().substring(1):connectionParams.basePath;
      basePath = connectionParams.basePath.toString().endsWith('/') ? basePath.toString().substring(0,basePath.toString().length-1):basePath;
