function TestE2EIntegerParamReturnDoubleErrorCond(itemCnt, price) {
...
retFloatPriceValue = retFloatPriceValue.toFixed(2);
}
console.debug("Return from CLIENT API new double value is : %s", retFloatPriceValue);
return encodeURI(retFloatPriceValue);
}

var t = TestE2EIntegerParamReturnDoubleErrorCond(xdmp.getRequestField("items"), xdmp.getRequestField("price"));
t;