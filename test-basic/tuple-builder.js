...
var t = require('../lib/tuple-builder.js');

describe('tuples query', function(){
  describe('with tuple builder', function(){
    ...
    it('should build a with options clause', function(){
      ...
      built.withOptionsClause.should.have.property('tuple');
      built.withOptionsClause.tuple.length.should.equal(1);
      built.withOptionsClause.tuple[0].should.equal('proximity=5');
    });
  });
});
