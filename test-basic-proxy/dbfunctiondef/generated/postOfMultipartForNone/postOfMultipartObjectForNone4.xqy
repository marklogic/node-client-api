...
let $funcdef   := xdmp:from-json-string('{
  "functionName" : "postOfMultipartObjectForNone4",
  "params" : [ {
    "name" : "param1",
    "datatype" : "object",
    "multiple" : false,
...
let $fields   := xdmp:apply(xdmp:function(xs:QName("addField"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfMultipartForNone/postOfMultipartObjectForNone4", $fields, "param1", $param1
    )
...
return xdmp:apply(xdmp:function(xs:QName("makeResult"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfMultipartForNone/postOfMultipartObjectForNone4", $funcdef, $fields, $errorList
    )
