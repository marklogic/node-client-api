...
let $funcdef   := xdmp:from-json-string('{
  "functionName" : "postOfUrlencodedForTextBoolean0",
  "params" : [ {
    "name" : "param1",
    "datatype" : "double",
    "multiple" : true,
...
let $fields   := xdmp:apply(xdmp:function(xs:QName("addField"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfUrlencodedForText/postOfUrlencodedForTextBoolean0", $fields, "param1", $param1
    )
...
return xdmp:apply(xdmp:function(xs:QName("makeResult"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfUrlencodedForText/postOfUrlencodedForTextBoolean0", $funcdef, $fields, $errorList
    )
