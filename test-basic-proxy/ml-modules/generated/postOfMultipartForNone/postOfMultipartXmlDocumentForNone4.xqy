...
let $funcdef   := xdmp:from-json-string('{
  "functionName" : "postOfMultipartXmlDocumentForNone4",
  "params" : [ {
    "name" : "param1",
...
let $fields   := xdmp:apply(xdmp:function(xs:QName("addField"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfMultipartForNone/postOfMultipartXmlDocumentForNone4", $fields, "param1", $param1
    )
...
return xdmp:apply(xdmp:function(xs:QName("makeResult"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfMultipartForNone/postOfMultipartXmlDocumentForNone4", $funcdef, $fields, $errorList
    )
