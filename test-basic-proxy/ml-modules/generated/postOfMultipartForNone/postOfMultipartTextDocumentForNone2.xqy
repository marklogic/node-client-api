...
let $funcdef   := xdmp:from-json-string('{
  "functionName" : "postOfMultipartTextDocumentForNone2",
  "params" : [ {
    "name" : "param1",
...
let $fields   := xdmp:apply(xdmp:function(xs:QName("addField"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfMultipartForNone/postOfMultipartTextDocumentForNone2", $fields, "param1", $param1
    )
...
return xdmp:apply(xdmp:function(xs:QName("makeResult"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfMultipartForNone/postOfMultipartTextDocumentForNone2", $funcdef, $fields, $errorList
    )
