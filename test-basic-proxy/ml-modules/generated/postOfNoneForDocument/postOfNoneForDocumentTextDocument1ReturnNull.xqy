...
let $funcdef   := xdmp:from-json-string('{
  "functionName" : "postOfNoneForDocumentTextDocument1ReturnNull",
  "return" : {
...
return xdmp:apply(xdmp:function(xs:QName("makeResult"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfNoneForDocument/postOfNoneForDocumentTextDocument1ReturnNull", $funcdef, $fields, $errorList
    )
