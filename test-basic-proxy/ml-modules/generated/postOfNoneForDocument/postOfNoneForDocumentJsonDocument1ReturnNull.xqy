...
let $funcdef   := xdmp:from-json-string('{
  "functionName" : "postOfNoneForDocumentJsonDocument1ReturnNull",
  "return" : {
...
return xdmp:apply(xdmp:function(xs:QName("makeResult"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfNoneForDocument/postOfNoneForDocumentJsonDocument1ReturnNull", $funcdef, $fields, $errorList
    )
