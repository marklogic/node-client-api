...
let $funcdef   := xdmp:from-json-string('{
  "functionName" : "postOfNoneForDocumentXmlDocument1ReturnNull",
  "return" : {
...
return xdmp:apply(xdmp:function(xs:QName("makeResult"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfNoneForDocument/postOfNoneForDocumentXmlDocument1ReturnNull", $funcdef, $fields, $errorList
    )
