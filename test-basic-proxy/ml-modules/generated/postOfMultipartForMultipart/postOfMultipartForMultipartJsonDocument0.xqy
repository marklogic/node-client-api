...
let $funcdef   := xdmp:from-json-string('{
  "functionName" : "postOfMultipartForMultipartJsonDocument0",
  "params" : [ {
    "name" : "param1",
...
let $fields   := xdmp:apply(xdmp:function(xs:QName("addField"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfMultipartForMultipart/postOfMultipartForMultipartJsonDocument0", $fields, "param1", $param1
    )
...
return xdmp:apply(xdmp:function(xs:QName("makeResult"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfMultipartForMultipart/postOfMultipartForMultipartJsonDocument0", $funcdef, $fields, $errorList
    )
