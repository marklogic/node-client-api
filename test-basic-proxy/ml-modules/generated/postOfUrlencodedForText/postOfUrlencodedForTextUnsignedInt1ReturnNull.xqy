...
let $funcdef   := xdmp:from-json-string('{
  "functionName" : "postOfUrlencodedForTextUnsignedInt1ReturnNull",
  "params" : [ {
    "name" : "param1",
    "datatype" : "double",
    "multiple" : true,
...
let $fields   := xdmp:apply(xdmp:function(xs:QName("addField"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfUrlencodedForText/postOfUrlencodedForTextUnsignedInt1ReturnNull", $fields, "param1", $param1
    )
...
return xdmp:apply(xdmp:function(xs:QName("makeResult"), "/dbf/test/testInspector.sjs"),
    "/dbf/test/postOfUrlencodedForText/postOfUrlencodedForTextUnsignedInt1ReturnNull", $funcdef, $fields, $errorList
    )
